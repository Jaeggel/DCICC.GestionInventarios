                ...
                if (infoUsuarioSesion != null)
                {
                    ...
                    if (msjUsuarios.OperacionExitosa)
                    {
                        ...
                        if (infoUsuario != null)
                        {
                            ...
                            ConfigBaseDatos.SetCadenaConexion(string.Format("Server='192.168.0.9';Port=5432;User Id={0};Password={1};Database=DCICC_BDInventario; CommandTimeout=3020;", infoUsuario.NickUsuario, ConfigEncryption.EncriptarValor(infoUsuario.PasswordUsuario)));
                        }
                        else
                        {
                            return Unauthorized();
